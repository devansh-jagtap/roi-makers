...
export const MobileNavMenu: React.FC<StaggeredMenuProps> = ({
  ...
  useLayoutEffect(() => {
    // Get the scope container element for GSAP context isolation
    const scope = scopeContainerRef.current;
    if (!scope) return;
  ...
  return (
    ...
    >
      <div
        ...
        style={accentColor ? ({ '--sm-accent': accentColor, pointerEvents: 'none' } as React.CSSProperties) : { pointerEvents: 'none' }}
      ...
      >
        ...
        >
          <div className="sm-logo flex items-center select-none pointer-events-auto ml-2 md:ml-4" aria-label="Logo">
            <img
        ...
        <aside
          ...
          ref={panelRef}
          className="staggered-menu-panel absolute top-0 right-0 h-full flex flex-col p-[6em_2em_2em_2em] overflow-y-auto z-10 backdrop-blur-[12px] pointer-events-auto bg-background"
